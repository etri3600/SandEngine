...
public:
	...
	virtual bool Update(const double delta, std::map<unsigned int, std::vector<SModel>>& models) = 0;
	virtual void Draw() = 0;
	...
	virtual void UpdateBoneTransform(const std::map<unsigned int, std::vector<SModel>>& models) = 0;
