...
bool SVulkan::Update(const double delta, std::map<EMaterialType, std::vector<SModel>>& models)
{
	return false;
}
...
void SVulkan::UpdateBoneTransform(const std::map<EMaterialType, std::vector<SModel>>& models)
{
}
